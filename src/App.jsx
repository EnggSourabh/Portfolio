  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          fontFamily: "Kanit, sans-serif", fontWeight: 600, letterSpacing: "0.2em",
...
function ContactButton({ label = "Download Resume", onClick, href }) {
  ...
  return (
    <button className="contact-btn" onClick={onClick || ((e) => handleSmoothScroll(e, "contact"))} style={baseStyle}>
      {label}
    </button>
  );
}
...
// ─── ANIMATED CHAR TEXT ──────────────────────────────────────────────────────
function AnimatedCharacter({ char, start, end, scrollYProgress }) {
...
function AnimatedText({ text, style = {} }) {
  ...
  return (
    <p ref={ref} style={{ position: "relative", ...style, display: "flex", flexWrap: "wrap", gap: "0.25em" }}>
      {words.map((word, wIdx) => {
        const wordNode = (
          <span key={wIdx} style={{ display: "inline-block", whiteSpace: "nowrap" }}>
            {word.split("").map((char, cIdx) => {
              ...
              charIndex++;
              return (
                <AnimatedCharacter key={cIdx} char={char} start={start} end={end} scrollYProgress={scrollYProgress} />
              );
            })}
          </span>
        );
        charIndex++; // Account for the space removed by split
        return wordNode;
      })}
    </p>
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center sm:items-end px-4 sm:px-10 pb-8 sm:pb-10 mt-auto relative z-20 gap-6 sm:gap-0">
        <motion.div
          className="flex flex-col sm:items-start items-center gap-3"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={{
        ...
        >
          {["FULL-STACK ENGINEER", "UI/UX DESIGNER", "FREELANCER"].map((role, i) => (
            <motion.div
              key={role}
              variants={{
                hidden: { opacity: 0, y: 80, scale: 0.7, filter: "blur(10px)" },
                visible: {
                  opacity: 1,
                  y: 0,
                  scale: 1,
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.4} y={20}>
        <ContactButton label="Contact Me" href="https://wa.me/918319238099?text=Hi%20Sourabh%2C%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20connect%21" />
      </FadeIn>
    </section>
  );
}
...
// ─── TECH ICON W/ HOVER EXPANSION ──────────────────────────────────────────────
function TechIcon({ label, icon }) {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: "50px",
        height: "45px",
        padding: isHovered ? "0 1.2rem 0 0.2rem" : "0",
        border: "1px solid",
        borderColor: isHovered ? "var(--accent-light)" : "var(--border-strong)",
        color: isHovered ? "var(--accent)" : "var(--accent-dark)",
        boxShadow: isHovered ? "0 8px 20px rgba(124, 58, 237, 0.15)" : "0 5px 15px rgba(0,0,0,0.03)",
        cursor: "default",
        overflow: "hidden",
      }}
      layout
    ...
    >
      <motion.div layout style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "45px", height: "45px", flexShrink: 0 }}>
        {icon || <span style={{ fontSize: "0.75rem", fontWeight: 700 }}>{label.substring(0, 2).toUpperCase()}</span>}
      </motion.div>
      {isHovered && (
        <motion.span
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", marginBottom: "3rem", position: "relative", zIndex: 30 }}>
          {project.tech.map((t) => {
  ...
  return (
    ...
    >
      ...
      <div style={{
        position: "absolute",
        top: 0,
        right: "clamp(2rem, 8vw, 6rem)", // Positioned securely on the right
        transform: "translate(0, -50%)",
        zIndex: 20
      }}>
        <Magnet padding={20} strength={1.5}>
          <motion.img
            src={avatar2Image}
      ...
      <FadeIn delay={0.35} y={20}>
        <div style={{ display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "3rem" }}>
          {[
            ...
            { label: "LinkedIn", icon: <LinkedinIcon size={22} />, href: "https://linkedin.com/in/enggsourabhmeena2027" },
            { label: "GitHub", icon: <GithubIcon size={22} />, href: "https://github.com/EnggSourabh" },
            { label: "LeetCode", icon: <Code size={22} strokeWidth={1.5} />, href: "https://leetcode.com/Sourabhme" },
          ].map((l) => (
            <a
              key={l.label}
              href={l.href}
              title={l.label} // Native tooltip for accessibility
              style={{
              ...
              onMouseLeave={e => {
                ...
                e.currentTarget.style.color = "var(--footer-accent)";
      ...
      <div style={{
        ...
        {/* Gem 1 - Medium, Purple/Pink */}
        <motion.div
          animate={{ left: ["-10%", "110%"], rotateX: [0, 1080], rotateY: [0, 1080], rotateZ: [0, 1080] }}
          transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
          style={{
            position: "absolute", bottom: "15px", width: "25px", height: "25px",
            background: "linear-gradient(135deg, rgba(124, 58, 237, 0.6), rgba(236, 72, 153, 0.6))",
            backdropFilter: "blur(5px)", border: "1px solid rgba(255,255,255,0.5)",
            borderRadius: "6px", boxShadow: "0 0 20px rgba(124, 58, 237, 0.8), inset 0 0 10px rgba(255,255,255,0.8)",
            transformStyle: "preserve-3d"
          }}
        />

        {/* Gem 2 - Small, Cyan/Blue, Faster */}
        <motion.div
          animate={{ left: ["-10%", "110%"], rotateX: [0, -720], rotateY: [0, 1080], rotateZ: [0, -360] }}
          transition={{ duration: 11, repeat: Infinity, ease: "linear", delay: 2 }}
          style={{
            position: "absolute", bottom: "5px", width: "15px", height: "15px",
            background: "linear-gradient(135deg, rgba(6, 182, 212, 0.6), rgba(59, 130, 246, 0.6))",
            backdropFilter: "blur(5px)", border: "1px solid rgba(255,255,255,0.5)",
            borderRadius: "4px", boxShadow: "0 0 15px rgba(6, 182, 212, 0.8), inset 0 0 8px rgba(255,255,255,0.8)",
            transformStyle: "preserve-3d"
          }}
        />

        {/* Gem 3 - Large, Green/Yellow, Slower */}
        <motion.div
          animate={{ left: ["-15%", "115%"], rotateX: [0, 360], rotateY: [0, -1080], rotateZ: [0, 720] }}
          transition={{ duration: 22, repeat: Infinity, ease: "linear", delay: 5 }}
          style={{
            position: "absolute", bottom: "20px", width: "35px", height: "35px",
            background: "linear-gradient(135deg, rgba(16, 185, 129, 0.4), rgba(245, 158, 11, 0.4))",
            backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.3)",
            borderRadius: "50%", boxShadow: "0 0 25px rgba(16, 185, 129, 0.5), inset 0 0 12px rgba(255,255,255,0.6)",
            transformStyle: "preserve-3d"
          }}
        />

        {/* Gem 4 - Tiny, Pink/Red, Very Fast */}
        <motion.div
          animate={{ left: ["-5%", "105%"], rotateX: [0, 1440], rotateY: [0, 1440], rotateZ: [0, -1440] }}
          transition={{ duration: 8, repeat: Infinity, ease: "linear", delay: 7 }}
          style={{
            position: "absolute", bottom: "35px", width: "10px", height: "10px",
            ...
            borderRadius: "2px", boxShadow: "0 0 10px rgba(239, 68, 68, 0.9)",
            transformStyle: "preserve-3d"
          }}
        />
      </div>
